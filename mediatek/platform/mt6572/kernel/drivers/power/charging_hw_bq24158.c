...
//2014/05/04-tedwu, Add for battery pack ID checking.
 ...
 static kal_uint32 charging_enable(void *data)
 {
	...
	else
	{
...
#endif 			
    	{
	       ...
	       // bq24158_set_ce(1);
            battery_xlog_printk(BAT_LOG_CRTI, "=> charging disabled.\r\n");	
    	}
	}
...
//<2014/05/30-tedwu, Set charging current for case down to 400mA.
#if defined(ARIMA_LO1_HW)
...
//<2014/04/17-tedwu, Add charging function. For fixing [defect BU2SC00145009].
static kal_uint32 charging_set_power_off(void *data)
{
    ...
    //<2014/10/08-Yuting Shih,Add reset function for charging when power off.
    #if defined( ARIMA_LO1_HW )
    /* Disable charger */
        bq24158_set_ce( 1 );
        //mdelay( 20 );
