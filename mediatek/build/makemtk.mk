...
ifneq ($(filter %-modem modem-info,$(MAKECMDGOALS)),)
...
#//<2014/03/31-georgelin, Add ota differential command
ANDROID_NATIVE_TARGETS := \
	 ...
	 dump-products bootimage-nodeps ramdisk-nodeps javaoptgen ota_diff
.PHONY: $(ANDROID_NATIVE_TARGETS)
#//>2014/03/31-georgelin
