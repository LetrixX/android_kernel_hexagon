...
CUSTOM_HAL_IMGSENSOR=s5k5eayx_yuv ov2675_mipi_yuv

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
#//<20140326-kyle chang, Select Fixed Focus only(sensordrive dummy_lens)
...
CUSTOM_HAL_MAIN_IMGSENSOR=s5k5eayx_yuv

# lens driver config for main camera
#//<20140326-kyle chang, Select Fixed Focus only(sensordrive)
...
CUSTOM_KERNEL_ACCELEROMETER=bma250e

# ALSPS sensor driverto detect ambint light and the object is close or far awary from device
#//<20140430-ShermanWei, auto detect for EP1 later
CUSTOM_KERNEL_ALSPS=cm36671_auto epl88051_auto
###cm36671
#//>20140430-ShermanWei
...
CUSTOM_KERNEL_IMGSENSOR=s5k5eayx_yuv ov2675_mipi_yuv
...
CUSTOM_KERNEL_MAIN_IMGSENSOR=s5k5eayx_yuv
...
CUSTOM_KERNEL_TOUCHPANEL=elan3257
...
CUSTOM_LK_LCM=hx8357c_hvga_dsi_vdo
...
#//<2014/6/11-LindaGuo,[5503][PTCRB][31.124][27.22.4.27.31]Open BIP_SCWS according mtk requirement.
MTK_BIP_SCWS=yes
#//>2014/6/11-LindaGuo
...
#//<2014/5/18-38193-RichardLi, [5502/5503][Lo1/Lo2] Enable BT BIP for BQB testing
MTK_BT_PROFILE_BIP=yes
#//<2014/5/18-38193-RichardLi
...
#<2014-04-02-35616-PengXu,[5502][MMS]Phone prompt "Unknown error" when add Calendar event to MMS
#MTK_CALENDAR_IMPORTER_APP=no
MTK_CALENDAR_IMPORTER_APP=yes
#>2014-04-02-35616-PengXu
...
#//<2014/06/21-39977-RichardLi-[5502][PTCRB] [16.3a] Droped so disable CMAS option
#//<2014/06/20-LindaGuo-[5503][PTCRB][16.3a]Turn on MTK_CMAS_SUPPORT .
MTK_CMAS_SUPPORT=no
#//>2014/06/20-LindaGuo
#//<2014/06/21-39977-RichardLi
...
# //<2014/03/24-georgelin, For fix BU2SC00144296, remove the DataTransfer.apk
MTK_DATA_TRANSFER_APP=no
# //>2014/03/24-georgelin
...
#//<2014/4/23-36755-LindaGuo, [5503]Remove MovieStudio & PlayNewsstand in LO2 as LG's requirement .
#MTK_ENABLE_VIDEO_EDITOR=yes
MTK_ENABLE_VIDEO_EDITOR=no
#//>2014/4/23-36755-LindaGuo
...
#<2014/04/22-LindaGuo, [5502][ETWS]Disable ETWS for LO2 .
...
#<2014/03/21-samhuang, remove MTK file manager app
...
# MTK_FLIGHT_MODE_POWER_OFF_MD is used to control if modem is powered off when entering flight mode MTK_TELEPHONY_MODE is used for specify current telephony mode MTK_FIRST_MD is used to specify the high priority modem
#<2014/04/09-masonmau,BU2SC00144476-The contact can't import/export from SIM card when flight mode on.
...
#<2014-05-16-37679-PengXu,[5503]Turn off MTK fast boot
#MTK_IPO_SUPPORT=yes
MTK_IPO_SUPPORT=no
#>2014-05-16-37679-PengXu
...
##//<2014/03/19-Yuting Shih. Modified the LCM screen rotation(180 -> 0)
# To set the angle between dimension of UI layout and LCM scan direction
MTK_LCM_PHYSICAL_ROTATION=0
##//>2014/03/19-Yuting Shih.

#//<2014/5/08-37653-RichardLi, [5502][Lo1/Lo2] Enable live wallpaper to fix CTS fail issue
...
#<2014/03/28-samhaung, use MTK's OOB
MTK_OOBE_APP=yes
#>2014/03/28-samhuang
...
# Support kernel suspend/resume statistics inquiry
...
MTK_PRODUCT_AAPT_CONFIG=mdpi hdpi
...
#//<2014/8/2-42171-Luckydong, [5502][Audio][Common]Disable MTK_SAFEMEDIA_SUPPORT switcher.
#//<2014/8/1-42107-Luckydong, [5502][Audio][Common]Enable MTK_SAFEMEDIA_SUPPORT switcher.
#modify by archermind_zhaopeng 20140729
MTK_SAFEMEDIA_SUPPORT=no
#//>2014/8/1-42107-Luckydong
#//<2014/8/2-42171-Luckydong
...
#//<2014/5/29-38953-Leolee, [5502]True on security boot feature.
MTK_SEC_BOOT=ATTR_SBOOT_ENABLE
#//>2014/5/29-38953-Leolee
...
# no :  Disable MTK wifi-display secure video path support.
...
MTK_SINGLE_IMEI=no
#<2014-04-20-36607-Richardli,[5502&5503][CTS]Modify CTS test items to meet LG request.
#<2014/03/31-masonmau,BU2SC00144497-The phone has no SIP call function.
MTK_SIP_SUPPORT=no
#>2014/03/31-masonmau
#>2014-04-18-36607-Richardli
...
MTK_SWIP_WMAPRO=no
#<2014/03/23-samhuang, disable MTK SW upgrade style
...
# Add for supporting transparent StatusBar/NavigationBar.
...
# This option is for HEVC vdec/venc feature.
...
#<2014/03/23-samhuang, disable 3G video call
...
BOOT_LOGO=LG_Telcel_hvga


# To choose kernel LCM driver name
CUSTOM_KERNEL_LCM=hx8357c_hvga_dsi_vdo

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=hx8357c_hvga_dsi_vdo
...
#<2014/05/02-37251-JichangDu,[5502][Settings][ISSUE4]Set default language as es_us and remove chinese.
MTK_PRODUCT_LOCALES=es_MX es_US en_US es_ES ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR pl_PL bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE en_GB ro_MD
#>2014/05/02-37251-JichangDu
...
#CREATE_PROJECT_INFO=20140311101017
MTK_BUILD_VERNO = LGE-LO2-K1.MP6.V1
...
ARIMA_LO1_HW                       = no
ARIMA_LO2_HW                       = yes
ARIMA_HW_VERSION                   = LO2_EP0
ARIMA_GUESTMODE_SUPPORT            = yes
ARIMA_MX_TELCEL_CUSTOMIZATION      = no
ARIMA_INDIA_CUSTOMIZATION          = yes
ARIMA_ASIA_CUSTOMIZATION           = no
ARIMA_CIS_CUSTOMIZATION            = no
ARIMA_MEA_CUSTOMIZATION            = no
ARIMA_SOUTH_AFRICA_CUSTOMIZATION   = no
#<2014-04-18-36567-PengXu,[5502 & 5503][CTS]modify ro.xxx for 5502 & 5503 CTS
#ARIMA_PRODUCT_MODEL                = X130g
ARIMA_PRODUCT_MODEL                = LG-X130g
ARIMA_PRODUCT_BRAND                = lge
ARIMA_PRODUCT_BRAND_CTS            = LGE
#>2014-04-18-36567-PengXu
#<2014-04-18-36567-PengXu,[5502 & 5503][CTS]modify ro.xxx for 5502 & 5503 CTS
#ARIMA_PRODUCT_NAME                = lo2_tcl_mx
ARIMA_PRODUCT_NAME                 = lo_2_tcl_mx
ARIMA_PROCDUCT_DEVICE_CTS          = lo_2
#>2014-04-18-36567-PengXu
#//< 2014/6/19-36609-Paul.zhang < Add the Chile_Claro version of the macro and language.>
ARIMA_CHILE_CLARO_CUSTOMIZATION      = no
#//>2014/6/19-36609-Paul.zhang

#//< 2014/6/13-36638-Paul.zhang < Add the Chile_Telefonica version of the macro>
ARIMA_CHILE_TELEFONICA_CUSTOMIZATION      = no
#//>2014/6/13-36638-Paul.zhang
#//< 2014/6/23-40002-Paul.zhang < Add the Chile_Entel version of the macro.>
ARIMA_CHILE_ENTEL_CUSTOMIZATION      = no
#//>2014/6/23-40002-Paul.zhang
#//< 2014/6/25-40011-Paul.zhang < Add the Mexico_Iusacell version of the macro.>
ARIMA_MEXICO_IUSACELL_CUSTOMIZATION     = no
#//>2014/6/25-40011-Paul.zhang
#//< 2014/6/26-40029-Paul.zhang < Add the Mexico_Telefonica version of the macro>
ARIMA_MEXICO_TELEFONICA_CUSTOMIZATION      = no
#//>2014/6/26-40029-Paul.zhang
#//< 2014/7/3-40278-Paul.zhang < Add the indonesia version of the macro.>
ARIMA_INDONESIA_CUSTOMIZATION      = no
#//>2014/7/3-40278-Paul.zhang
#//< 2014/7/2-40274-Paul.zhang < Add the philippines version of the macro.>
ARIMA_PHILIPPINES_CUSTOMIZATION      = no
#//>2014/7/2-40274-Paul.zhang
#//< 2014/7/4-40289-Paul.zhang < Add the vietnam version of the macro.>
ARIMA_VIETNAM_CUSTOMIZATION      = no
#//>2014/7/4-40289-Paul.zhang
#//< 2014/07/21-41258-Paul.zhang  [5502][Bolivia_Tigo][Make_File][Add the Bolivia_Tigo version of the macro]
ARIMA_BOLIVIA_TIGO_CUSTOMIZATION      = no
#//>2014/07/21-41258-Paul.zhang
ARIMA_LOX_HW_VERSION	= LO2_EP0
ARIMA_GMS_SUPPORT                  = yes
#<2014-05-28-38802-PengXu,[5503]Add build id which is different from lo2 for lo1
#<2014-06-02-38993-RichardLi,[5502][Lo2] Fix build ID error 
ARIMA_LO2_BUILD_ID                 = KOT49H.V10a
#<2014-06-02-38993-RichardLi
#>2014-05-28-38802-PengXu
#// <2014-06-30-40527-Leolee, [5502][CA] Add secret code to enter hidden menu following CA version.
ARIMA_CIS_CUSTOMIZATION_2G = no
ARIMA_CIS_CUSTOMIZATION_3G = no
#// >2014-06-30-40527-Leolee
#// <2014-07-09-40927-Leolee, [5502][CA] Add secret code to enter hidden menu following CA version.
ARIMA_NIGERIA_CUSTOMIZATION_2G = no
ARIMA_INDIA_CUSTOMIZATION_2G = no
#// >2014-07-09-40927-Leolee
#//< 2014/7/15-40728-Paul.zhang [5503][Nigeria][Add the nigeria version of the macro.]
ARIMA_NIGERIA_CUSTOMIZATION      = no
#//>2014/7/15-40728-Paul.zhang
#//< 2014/7/15-41226-Paul.zhang [5503][Saudi_Arabia][Make_File][Add the Saudi_Arabia version of the macro.]
ARIMA_SAUDI_ARABIA_CUSTOMIZATION      = no
#//>2014/7/15-41226-Paul.zhang
#//< 2014/07/21-41273-Paul.zhang  [5502][Paraguay_Tigo][Make_File][Add the Paraguay_Tigo version of the macro]
ARIMA_PARAGUAY_TIGO_CUSTOMIZATION      = no
#//>2014/07/21-41273-Paul.zhang
#//< 2014/8/21-42584-xuan.zhou [5503][GCC][Make_File][Add the GCC version of the macro.]
ARIMA_SAUDI_UAE_TUNISIA_CUSTOMIZATION  = no
#//>2014/8/21-42584-xuan.zhou
#//<2014/8/28-43286-LindaGuo, [5503][Common][GoogleFolder]Customized google apps for each version .
ARIMA_UKRAINE_CUSTOMIZATION      = no
ARIMA_KAZAKHASTAN_CUSTOMIZATION      = no
#//>2014/8/28-43286-LindaGuo
#//< 2014/08/26-42595-xuan.zhou, [5503][ROMEA][Make_File][Add the ROMEA version of the macro.]
ARIMA_ROMEA_CUSTOMIZATION   = no
#//>2014/08/26-42595-xuan.zhou
#//>2014/07/21-41273-Paul.zhang   
#//< 2014/09/03-43362-xuan.zhou, [5503][SGP][Make_File][Add the SGP version of the macro.]
ARIMA_SGP_CUSTOMIZATION   = no
#//>2014/09/03-43362-xuan.zhou
#//< 2014/09/09-43390-xuan.zhou, [5503][Spain][Make_File][Add the Spain version of the macro.]
ARIMA_SPAIN_CUSTOMIZATION   = no
#//>2014/09/09-43390-xuan.zhou
#//<2014/09/16-43656-xiaoleiding, [5503][MEXICO][CHILE]Automatic change of SW Version depending on SIM lock/Unclock state
ARIMA_SW_VERSION_FROM_SIM_LOCK      = no
#//>2014/09/16-43656-xiaoleiding
#//< 2014/09/09-43376-xuan.zhou, [5503][Italy][Make_File][Add the Italy version of the macro.]
ARIMA_ITALY_CUSTOMIZATION   = no
#//>2014/09/09-43376-xuan.zhou
#//<2014/10/14-44839-LeoLee, [5503][France][Make_File][Add the France version of the macro.]
ARIMA_FRANCE_CUSTOMIZATION   = no
#//>2014/10/14-44839-LeoLee
#//< 2014/11/18-44452-xuan.zhou, [5503][Thailand][Make_File]Add the Thailand version of the macro.
ARIMA_THAILAND_CUSTOMIZATION   = no
#//>2014/11/18-44452-xuan.zhou
