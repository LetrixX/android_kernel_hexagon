...
CUSTOM_LK_LCM=otm8018b_wvga_dsi_vdo
...
#<2014/04/22-40792-RichardLi, [5503][TD3830] Disable ETWS to set the CB default setting as off
#MTK_ETWS_SUPPORT=yes
MTK_ETWS_SUPPORT=no
#<2014/04/22-40792-RichardLi
...
#//<2014/5/29-38953-Leolee, [5503]True on security boot feature.
...
#//<2014/10/18-44985-Leolee, [5503][Common]Remove 44920 from main stream and add it to ESP stream. 
#//<2014/10/16-44920-LindaGuo, [5503][SPAIN][TD4197]The behavior is incorrect after the phone received ACTIVATE CONTEXT REJECT message .
MTK_SPECIFIC_SM_CAUSE=no
#//>2014/10/16-44920-LindaGuo
#//>2014/10/18-44985-Leolee
...
CUSTOM_KERNEL_LCM=otm8018b_wvga_dsi_vdo
# CUSTOM_KERNEL_LCM=otm8019a_wvga_dsi_vdo

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=otm8018b_wvga_dsi_vdo
# CUSTOM_UBOOT_LCM=otm8019a_wvga_dsi_vdo
...
MTK_PRODUCT_LOCALES=en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE en_GB ro_MD
...
MTK_BUILD_VERNO = LGE-LO1-KK1.MP6.V1
...
#ARIMA_PRODUCT_MODEL                = X147
ARIMA_PRODUCT_MODEL                = LG-X147
ARIMA_PRODUCT_BRAND                = lge
ARIMA_PRODUCT_BRAND_CTS            = LGE
#>2014-04-18-36567-PengXu
#<2014-04-18-36567-PengXu,[5502 & 5503][CTS]modify ro.xxx for 5502 & 5503 CTS
#ARIMA_PRODUCT_NAME                = lo1_open_in
ARIMA_PRODUCT_NAME                 = lo_1_open_in
ARIMA_PROCDUCT_DEVICE_CTS          = lo_1
#>2014-04-18-36567-PengXu
ARIMA_LOX_HW_VERSION	= LO1_EP0
ARIMA_GMS_SUPPORT                  = yes
#<2014-05-28-38802-PengXu,[5503]Add build id which is different from lo2 for lo1
ARIMA_LO1_BUILD_ID                 = KOT49H.V09c
#>2014-05-28-38802-PengXu
#//< 2014/6/13-36609-Paul.zhang < Add the Chile_Telefonica version of the macro>
ARIMA_CHILE_TELEFONICA_CUSTOMIZATION      = no
#//>2014/6/13-36609-Paul.zhang
#//< 2014/6/19-36638-Paul.zhang < Add the Chile_Claro version of the macro and language.>
ARIMA_CHILE_CLARO_CUSTOMIZATION      = no
#//>2014/6/19-36638-Paul.zhang
